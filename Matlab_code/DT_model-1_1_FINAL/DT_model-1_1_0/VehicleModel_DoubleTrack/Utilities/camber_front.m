function camber_front(vehicle_data,Ts,Tf)
    ...
    hold on
    for i = 1:5
        plot(Ay(10000:end,i)./g, Ackerman(10000:end)-Rho2(10000:end,i), 'LineWidth',2, 'DisplayName',("$\gamma_f$ = " + +(-camber_vec(1,i))), 'Color', colorMap(i,:));
